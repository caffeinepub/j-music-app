...
export class Backend implements backendInterface {
    ...
    async deleteComposition(arg0: CompositionId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async listCompositions(): Promise<Array<[SongName, CompositionId]>> {
        if (this.processError) {
            try {
    ...
    async loadComposition(arg0: CompositionId): Promise<Uint8Array> {
        if (this.processError) {
            try {
                const result = await this.actor.loadComposition(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveComposition(arg0: SongName, arg1: Uint8Array): Promise<CompositionId> {
        if (this.processError) {
            try {
                const result = await this.actor.saveComposition(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
